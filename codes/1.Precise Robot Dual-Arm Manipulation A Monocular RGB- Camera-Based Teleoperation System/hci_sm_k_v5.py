    ...
    def infer(self, function=None):
        ...
        while True:
            ...
            if self.detector == 'anchor':
                ...
                # spatial_mapping
                pub_pose.x = (pub_pose.x/1000-0.25)*0.15/0.5 +0.325
                pub_pose.y = (pub_pose.y/1000+0.3)*2
                pub_pose.z = (pub_pose.z/1000-0.25)*0.48/0.5 +0.36
                ...
                pub_pose2.x = (pub_pose2.x/1000-0.25)*0.15/0.5 +0.325
                pub_pose2.y = (pub_pose2.y/1000-0.3)*2
                pub_pose2.z = (pub_pose2.z/1000-0.25)*0.48/0.5 +0.36
