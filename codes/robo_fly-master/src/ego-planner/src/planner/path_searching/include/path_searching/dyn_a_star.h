...
private:
	...
	inline bool checkOccupancy(const Eigen::Vector3d &pos,int astar_occ_id) { return (bool)grid_map_->getInflateOccupancy(pos,astar_occ_id); }
...
public:
	...
	bool AstarSearch(const double step_size, Eigen::Vector3d start_pt, Eigen::Vector3d end_pt,int wp_id_);
