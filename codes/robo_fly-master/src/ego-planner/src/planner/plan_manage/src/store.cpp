...
namespace ego_planner
{
  ...
  bool EGOPlannerManager::reboundReplan(Eigen::Vector3d start_pt, Eigen::Vector3d start_vel,
                                        ...
                                        Eigen::Vector3d local_target_vel, bool flag_polyInit, bool flag_randomPolyTraj)   // flag_polyInit true; flag_randomPolyTraj
  {
    static int count = 0;
                                         ...
                                         const Eigen::Vector3d &end_pos, const Eigen::Vector3d &end_vel, const Eigen::Vector3d &end_acc)
  {
    ...
    gl_traj_2 = PolynomialTraj::one_segment_traj_gen(mid_pos, mid_vel, mid_acc, end_pos, end_vel, end_acc, time(0));
