...
#include <Eigen/Eigen>
#include </home/kingstrong05/robo_fly/src/ego-planner/src/planner/path_searching/include/path_searching/dyn_a_star.h>
...
namespace ego_planner
{
  ...
  public:
    ...
    void setLocalTargetPt(const Eigen::Vector3d local_target_pt,int wp_id_) { local_target_pt_ = local_target_pt;occ_wp_id_ =  wp_id_;};
    ...
    std::vector<ControlPoints> distinctiveTrajs(vector<std::pair<int, int>> segments,int wp_id_);
