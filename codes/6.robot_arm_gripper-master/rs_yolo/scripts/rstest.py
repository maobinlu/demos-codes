...
class YoloV5:
    def __init__(self, yolov5_yaml_path='/home/nuc/arm807_hand_ws/src/robot_arm_gripper/rs_yolo/scripts/config/yolov5s.yaml'):
        '''初始化'''
        # 载入配置文件
...
if __name__ == '__main__':
    ...
    model = YoloV5(yolov5_yaml_path='/home/nuc/arm807_hand_ws/src/robot_arm_gripper/rs_yolo/scripts/config/yolov5s.yaml')
