...
namespace ego_planner
{
  ...
  public:
    ...
    bool reboundReplan(Eigen::Vector3d start_pt, Eigen::Vector3d start_vel, Eigen::Vector3d start_acc,
                       Eigen::Vector3d end_pt, Eigen::Vector3d end_vel, Eigen::Vector3d wps_1,Eigen::Vector3d wps_2,Eigen::Vector3d wpv_1,int wp_id_,bool flag_polyInit, bool flag_randomPolyTraj);
