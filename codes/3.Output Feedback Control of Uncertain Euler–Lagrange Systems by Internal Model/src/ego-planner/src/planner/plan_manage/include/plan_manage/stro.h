...
#include "ego_planner/CirclePoses.h"
...
namespace ego_planner
{
  ...
  private:
    ...
    ros::Subscriber waypoint_sub_, odom_sub_, swarm_trajs_sub_, broadcast_bspline_sub_, trigger_sub_, robopos_sub;
    ...
    void robopos_cb(const ego_planner::CirclePosesConstPtr &msg);
